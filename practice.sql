...
INSERT INTO `evangel` VALUES (1,'【报佳音】我校荣获2020年度全市高校安全稳定工作先进单位','2021-01-04','。。。'),(2,'【报佳音】我校教师获“全国巾帼建功标兵”称号','2021-05-04','。。。');
...
INSERT INTO `journalism` VALUES (2,'我校召开党史学习教育党委中心组（扩大）学习会','2021-05-08','。。。'),(3,'我校第六届大学生模拟招聘大赛圆满落幕',NULL,'。。。'),(4,'聚焦人民信仰，献礼建党百年——我校大型原创话剧《宣言》在重庆','2021-05-08','。。。'),(5,'奋斗不止，青春正当时——我校召开庆祝中国共产党成立100周年','2021-05-07','。。。');
...
INSERT INTO `menu` VALUES (1,'/',NULL,1,'所有',''),(2,'/home',1,1,'所有管理','Home'),(3,'/db/**',2,1,'成绩管理','Score'),(4,'/admin/**',2,1,'基本信息','Information'),(5,'/student/**',2,1,'学生管理','Student'),(6,'/home',1,1,'权限管理','Home'),(7,'/user/**',6,1,'用户管理','UserManage'),(8,'/teacher/**',2,1,'教师管理','Teacher'),(9,'/course/**',2,1,'课程管理','CourseManager'),(10,'/article/**',2,1,'文章管理','Article'),(11,'/journalism/**',2,1,'重师要闻','Journalism'),(12,'/evangel/**',2,1,'佳音在线','Evangel'),(13,'/special/**',2,1,'专题聚焦','Special'),(14,'/science/**',2,1,'学术动态','Science'),(15,'/subject/**',2,1,'学科建设','Subject'),(16,'/message/**',2,1,'通知公告','Message');
...
INSERT INTO `message` VALUES (1,'中共重庆师范大学委员会关于公开选拔马克思主义学院执行院长的公','2021-05-09','。。。。。');
...
INSERT INTO `science` VALUES (1,'四川大学历史文化学院博士生导师杨天宏教授应邀来校讲学','2021-05-03','。。。'),(2,'培根铸魂，守正创新：仲呈祥做客我校新闻大讲堂','2021-05-06','。。。'),(3,'华中师范大学博士生导师崔鸿教授应邀来我校作专题讲座','2021-05-03','。。。');
...
INSERT INTO `special` VALUES (1,'【第一线】广东第二师范学院一行来校交流','2021-05-06','。。。');
...
INSERT INTO `subject` VALUES (1,'我校召开全国专业学位水平评估工作布置会','2021-05-06','。。。');
